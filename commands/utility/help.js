        ...
        if (args.join(" ") == "music") {
            ...
            const newEmbed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    {name: `${prefix}clear *1*`, value: 'apus message'},
                    ...
                    {name: `${prefix}image *car*`, value: 'cari gambar di google'},
                    {name: `${prefix}reactionrole`, value: 'buat pilih role (ada 3)'},
                    {name: `${prefix}gif *car*`, value: 'kirim gif dari tenor'},
                    {name: `${prefix}gipy *car*`, value: 'kirim gif dari giphy'},
                    {name: `${prefix}hey`, value: 'sapa sapa aja'},
                    {name: `${prefix}avatar`, value: 'liat profile pic, bisa juga kl tag orang'},
