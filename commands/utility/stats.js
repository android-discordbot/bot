  ...
  execute(client, message, args, cmd, Discord) {
    ...
    if (args[0] === "playing") {
      ...
      const statsEmbed = new Discord.MessageEmbed()
        ...
        .setDescription(`Format : **${prefix}stats <type> <content>**`)
        .addFields(
          {
            name: "<type>",
            value: "`streaming` `listening` `watching` `competing`",
          },
          { name: "<content>", value: "put anything here" },
          { name: "\u200B", value: "\u200B" },
          {
            name: "example",
            value: `${prefix}stats playing games \n ${prefix}stats listening commands`,
          }
        );
